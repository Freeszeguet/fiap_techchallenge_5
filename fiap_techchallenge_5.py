...
st.sidebar.text("Curso: Data Analytics")
...
if page == "Análise Exploratória":
    ...
    image_dir = "plots/" 
    image_files = ["idade.png", "instituicao_ensino.png", "output.png","pedra.png","tempo_na)ong.png","turmas.png"]
    images = [
        {
            "filename": "idade.png",
            "title": "Gráfico de Distribuição de Idade",
            "caption": "Idade x Ano",
            "description": "Este gráfico mostra a distribuição das idades dos alunos ao longo dos anos 2020, 2021 e 2022. A maioria dos alunos tem entre 9 e 14 anos, com picos notáveis em 10 anos de idade, indicando que essa faixa etária é a mais representativa entre os alunos da instituição. Não existem dados para 2021 e 2022."
        },
        {
